          ...
          <div className="bg-gray-800 border border-gray-600 rounded-xl p-6 w-full max-w-sm text-center shadow-xl animate-fade-in">
            ...
            <div className="flex justify-center gap-4">
              <button
                ...
                className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded cursor-pointer font-semibold"
              >
                Yes, Logout
              </button>
              <button
                onClick={() => setShowLogoutConfirm(false)}
                className="px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded cursor-pointer font-semibold"
              >
                No, Stay
              </button>
            </div>
